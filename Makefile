...
SRCS=events.c graphics.c key_functions.c main.c matrix.c matrix_ops2.c matrix_ops3.c matrix_ops.c matrix_transformations.c rendering.c vectors.c vectors2.c vectors3.c gl_objects.c shaders.c
